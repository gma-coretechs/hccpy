...
def write_output(df):
    ...
    logger.info("WRITING: {}".format(output_path + "NW_diag_HCC_raf_new_V22_V24.parquet"))
    df.write.mode('overwrite').parquet(output_path + 'NW_diag_HCC_raf_new_V22_V24.parquet')
    return df
...
def main():
    ...
    cclf1 = cclf1.withColumn('source_file', f.regexp_replace('source_file', 'August21Claims', 'data/unzipped/v25/08-2021'))
    cclf1 = cclf1.withColumn('source_file', f.regexp_replace('source_file', 'July21Claims', 'data/unzipped/v25/07-2021'))
    cclf1 = cclf1.withColumn('source_file', f.regexp_replace('source_file', 'June21Claims', 'data/unzipped/v25/06-2021'))
    
    cclf4 = cclf4.withColumn('source_file', f.regexp_replace('source_file', 'August21Claims', 'data/unzipped/v25/08-2021'))
    cclf4 = cclf4.withColumn('source_file', f.regexp_replace('source_file', 'July21Claims', 'data/unzipped/v25/07-2021'))
    cclf4 = cclf4.withColumn('source_file', f.regexp_replace('source_file', 'June21Claims', 'data/unzipped/v25/06-2021'))

    cclf5 = cclf5.withColumn('source_file', f.regexp_replace('source_file', 'August21Claims', 'data/unzipped/v25/08-2021'))
    cclf5 = cclf5.withColumn('source_file', f.regexp_replace('source_file', 'July21Claims', 'data/unzipped/v25/07-2021'))
    cclf5 = cclf5.withColumn('source_file', f.regexp_replace('source_file', 'June21Claims', 'data/unzipped/v25/06-2021'))

    cclf8 = cclf8.withColumn('source_file', f.regexp_replace('source_file', 'August21Claims', 'data/unzipped/v25/08-2021'))
    cclf8 = cclf8.withColumn('source_file', f.regexp_replace('source_file', 'July21Claims', 'data/unzipped/v25/07-2021'))
    cclf8 = cclf8.withColumn('source_file', f.regexp_replace('source_file', 'June21Claims', 'data/unzipped/v25/06-2021'))
    ...
    master = master.select('BENE_MBI_ID', 'BENE_AGE', 'BENE_SEX_CD', 'concat_elig', 'oerc', 'source_year', 'claim_year', 'diagnosis_list', 'cum_diag_diff', 'total_diag')
    ...
    result_master = pd.concat([result_master, df_result['risk_score'], df_result['hcc_lst'], df_result['hcc_map'], df_result['details'],df_result_diff['risk_score_diff'], df_result_diff['hcc_lst_diff'], df_result_diff['hcc_map_diff'], df_result_diff['details_diff']], axis=1)
    
    result_master = result_master[['BENE_MBI_ID', 'BENE_AGE', 'BENE_SEX_CD', 'concat_elig', 'oerc', 'source_year', 'claim_year', 'hcc_lst', 'hcc_map', 'risk_score', 'details', 'hcc_lst_diff', 'hcc_map_diff', 'details_diff', 'risk_score_diff']]
    ...
    master = spark.createDataFrame(result_master)
    ...
    master = master.withColumn('hcc_map_diags',f.from_json('hcc_map', 'map<string,string>')).withColumn('hcc_map_diags', f.map_keys('hcc_map_diags'))
    master = master.withColumn('hcc_map_diff_diags',f.from_json('hcc_map_diff', 'map<string,string>')).withColumn('hcc_map_diff_diags', f.map_keys('hcc_map_diff_diags'))
    master = master.select('BENE_MBI_ID', 'BENE_AGE', 'BENE_SEX_CD', 'concat_elig', 'oerc', 'source_year', 'claim_year', 'hcc_lst', 'hcc_map', 'hcc_map_diags', 'risk_score', 'risk_score_diff', 'details', 'hcc_lst_diff', 'hcc_map_diff', 'hcc_map_diff_diags', 'details_diff', 'cum_hcc_diff')
