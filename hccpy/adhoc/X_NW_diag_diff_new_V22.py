...
def write_output(df):
    ...
    logger.info("WRITING: {}".format(output_path + "NW_diag_HCC_raf_new_V22.parquet"))
    df.write.mode('overwrite').parquet(output_path + 'NW_diag_HCC_raf_new_V22.parquet')
    return df
...
def main():
    ...
    master = master.select('BENE_MBI_ID', 'BENE_AGE', 'BENE_SEX_CD', 'concat_elig', 'oerc', 'source_year', 'claim_year', 'hcc_lst', 'hcc_map', 'risk_score', 'risk_score_diff', 'details', 'hcc_lst_diff', 'hcc_map_diff', 'details_diff', 'cum_hcc_diff')
