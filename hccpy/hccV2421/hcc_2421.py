...
import _V24I0ED2 as V24I0ED2  # age sex edits (v22, v23,  v24)
import _V2218O1M as V2218O1M  # interactions (v22)
import _V2318P1M as V2318P1M  # interactions (v23)
import _V2419P1M as V2419P1M  # interactions (v24_19)
import _V2421P2M as V2421P2M  # interactions (v24_21)
import _AGESEXV2 as AGESEXV2  # disabled/origds (v22, v23, v24)
import _V2218O1P as V2218O1P  # risk coefn (v22, v23, v24)


class HCCEngine:

    def __init__(self, version="24_21", year="2021"):
        fnmaps = {"22": {"dx2cc": "data/F2218O1P.TXT",
                         "coefn": "data/V22hcccoefn.csv",
                         "label": "data/V22H79L1.TXT",
                         "hier": "data/V22H79H1.TXT"
                         },
                  "23": {"dx2cc": "data/F2318P1Q.TXT",
                         "coefn": "data/V23hcccoefn.csv",
                         "label": "data/V23H83L2.TXT",
                         "hier": "data/V23H83H1.TXT"
                         },
                  "24_19": {"dx2cc": "data/F2419P1M.TXT",
                            "coefn": "data/V24hcccoefn.csv",
                            "label": "data/V24H86L1.TXT",
                            "label_short": "data/V24_label_short.json",
                            "hier": "data/V24H86H1.TXT"
                            },
                  "24_21": {"dx2cc": "hccV2421/ref/F2421P2M.TXT",
                            "coefn": "hccV2421/ref/V24hcccoefn.csv",
                            "label": "hccV2421/ref/V24H86L1.TXT",
                            "label_short": "hccV2421/ref/V24_label_short.json",
                            "hier": "hccV2421/ref/V24H86H1.TXT"
                            }
                  }
    ...
    def _apply_interactions(self, cc_lst, age, disabled):
        ...
        elif self.version == "24_19":
            cc_lst = V2419P1M.create_interactions(cc_lst, disabled, age)
        elif self.version == "24_21":
            cc_lst = V2421P2M.create_interactions(cc_lst, disabled, age)
        return cc_lst
    ...
    def profile(self, dx_lst, age=70, sex="M",
        ...
        cc_dct = V24I0ED2.apply_agesex_edits(cc_dct, age, sex)
